DROP TABLE transaction_transaction_r IF EXISTS;
DROP TABLE transaction IF EXISTS;
DROP TABLE member IF EXISTS;
DROP TABLE member_type IF EXISTS;
DROP TABLE membership_county IF EXISTS;
DROP TABLE membership IF EXISTS;
DROP TABLE codevalue IF EXISTS;
DROP TABLE codeset IF EXISTS;
...
CREATE TABLE membership (
	...
	membership_type_cd			BIGINT NOT NULL,
...
CREATE TABLE transaction (
	...
	transaction_type_cd			BIGINT NOT NULL,
