...
INSERT INTO membership (membership_id, entity_type_cd, next_due_dt, fixed_dues, create_dt_tm, create_id, updt_dt_tm, updt_id) VALUES (2, 1, '2015-01-23', 100, CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0);
...
INSERT INTO document (document_id, parent_entity_id, parent_entity_name, document_type, document_name, document_format, document_desc, beg_eff_dt, create_dt_tm, create_id, updt_dt_tm, updt_id) VALUES (1, 1, 'MEMBERSHIP', 'RENEWAL_LETTER', 'renewal_letter.pdf', 'PDF', '2013 - 2014 Renewal Letter', '2014-03-01', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1);
INSERT INTO document (document_id, parent_entity_id, parent_entity_name, document_type, document_name, document_format, document_desc, beg_eff_dt, create_dt_tm, create_id, updt_dt_tm, updt_id) VALUES (2, 1, 'MEMBERSHIP', 'RENEWAL_LETTER', 'renewal_letter.pdf', 'PDF', '2014 - 2015 Renewal Letter', '2015-03-01', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1);
INSERT INTO document (document_id, parent_entity_id, parent_entity_name, document_type, document_name, document_format, document_desc, beg_eff_dt, create_dt_tm, create_id, updt_dt_tm, updt_id) VALUES (3, 3, 'MEMBERSHIP', 'RENEWAL_LETTER', 'renewal_letter.pdf', 'PDF', '2014 - 2015 Renewal Letter', '2015-03-01', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1);
INSERT INTO document (document_id, document_type, document_name, document_format, document_desc, beg_eff_dt, end_eff_dt, create_dt_tm, create_id, updt_dt_tm, updt_id) VALUES (4, 'NEWS_LETTER', 'newsletter.pdf', 'PDF', '2015 News Letter', '2015-03-01', '2015-10-31', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1);
INSERT INTO document (document_id, document_type, document_name, document_format, document_desc, beg_eff_dt, create_dt_tm, create_id, updt_dt_tm, updt_id) VALUES (5, 'NEWS_LETTER', 'newsletter.pdf', 'PDF', '2016 News Letter', '2015-03-06', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1);
