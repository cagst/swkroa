...
/* package */final class MembershipMapper implements RowMapper<Membership> {
   ...
   *
   * @param memberRepo    The {@link MembershipRepository} to use to retrieve additional membership values.
   * @param codeValueRepo The {@link CodeValueRepository} to use to retrieve additional membership values.
   */
   ...
   *
   * @param membership The {@link Membership} to map into an insert statement.
   ...
   *
   * @param membership The {@link Membership} to map into an update statement.
   * @param user       The {@link User} that performed the changes.
   * @return A {@link MapSqlParameterSource} that can be used in a {@code jdbcTemplate.update} statement.
   */
