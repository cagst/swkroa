...
public class UserServiceImpl implements UserService, MessageSourceAware {
	...
	public UserServiceImpl(final UserRepository userRepo, final RoleRepository roleRepo,
			final SecurityService securityService, final PasswordEncoder passwordEncoder) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#signinSuccessful(com.cagst.swkroa.user.User, java.lang.String)
	 */
	@Override
	@Transactional
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#signinFailure(java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#signedOut(com.cagst.swkroa.user.User)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#timedOut(com.cagst.swkroa.user.User)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#changePassword(com.cagst.swkroa.user.User, java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#unlockAccount(com.cagst.swkroa.user.User, com.cagst.swkroa.user.User)
	 */
	@Override
	@Transactional
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#doesUsernameExist(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.cagst.swkroa.user.UserService#saveUser(com.cagst.swkroa.user.UserBuilder, com.cagst.swkroa.user.User)
	 */
	@Override
	@Transactional
