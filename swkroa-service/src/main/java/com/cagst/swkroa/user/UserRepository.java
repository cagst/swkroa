...
public interface UserRepository {
   ...
   *
   * @param username The {@link String} username that identifies the {@link User} to retrieve.
   * @return The {@link User} associated to the specified username. <code>null</code> if no
   * {@link User} is associated to this username.
   * @throws IllegalArgumentException if username is <code>null</code> or is empty.
   */
   ...
   *
   * @param uid A {@link long} that uniquely identifies the User to retrieve.
   ...
   *
   * @param user The {@link User} attempting to signin.
   * @return The {@link User} that has been updated accordingly.
   * @throws IllegalArgumentException if <code>user</code> is null
   */
   ...
   * @param ipAddress The ipAddress where the user was when they successfully signed in.
   * @return The {@link User} that has been updated accordingly.
   * @throws IllegalArgumentException if <code>user</code> is null
   */
   ...
   * attempts.
   *
   * @param lockUser The {@link User} who's account is to be locked.
   * @param message  A descriptive message describing why the account as locked.
   * @param user     The {@link User} that is performing the lock.
   *
   * @return The {@link User} that has been locked and updated accordingly.
   *
   * @throws IllegalArgumentException if {@code user} is null
   */
  public User lockUserAccount(final User lockUser, final String message, final User user) throws IllegalArgumentException;
   ...
   *
   * @param unlockUser The {@link User} who's account is to be unlocked.
   * @param message    A descriptive message describing why the account was unlocked.
   * @param user       The {@link User} that is performing the unlock.
   *
   * @return The {@link User} that has been successfully unlocked and updated accordingly.
   *
   * @throws IllegalArgumentException if {@code user} is null
   */
  public User unlockUserAccount(final User unlockUser, final String message, final User user) throws IllegalArgumentException;

  /**
   * Enables the specified {@link User} account.
   *
   * @param enableUser The {@link User} who's account is to be enabled.
   * @param message    A descriptive message describing why the account was enabled.
   * @param user       The {@link User} that is performing the enabling of the account.
   *
   * @return The {@link User} that has been successfully enabled and updated accordingly.
   *
   * @throws IllegalArgumentException
   */
  public User enableUserAccount(final User enableUser, final String message, final User user) throws IllegalArgumentException;

  /**
   * Disables the specified {@link User} account.
   *
   * @param disableUser The {@link User} who's account is to be disabled.
   * @param message     A descriptive message describing why the account was disabled.
   * @param user        The {@link User} that is performing the disabling of the account.
   *
   * @return The {@link User} that has been successfully disabled and updated accordingly.
   *
   * @throws IllegalArgumentException
   */
  public User disableUserAccount(final User disableUser, final String message, final User user) throws IllegalArgumentException;
   ...
   * for the user.
   *
   * @param user        The {@link User} who's password we are changing.
   * @param newPassword The {@link String Password} to change to.
   * @param message     A descriptive message of the change password event.
   * @return A new {@link User} with it's password changed.
   * @throws IllegalArgumentException if <code>user</code> is null or <code>password</code> is null or empty
   */
   ...
   *
   * @param username The {@link String} username to check.
   ...
   *
   * @param username The {@link String} username to check.
   * @param user     The {@link User} to possibly exclude from the check.
   * @return {@code true} if the username is already being used, {@code false} if not.
   */
   ...
   *
   * @param builder The {@link User} to persist.
   * @param user    The {@link User} that performed the changes.
   * @return A {@link User} once it has been committed to persistent storage.
   * @throws OptimisticLockingFailureException      if the updt_cnt doesn't match (meaning someone has updated it since it was last read)
   * @throws IncorrectResultSizeDataAccessException if the number of rows inserted / updated exceeded the expected number
   * @throws UsernameTakenException                 if the username associated to the {@code builder} is already being used by another
   *                                                user
