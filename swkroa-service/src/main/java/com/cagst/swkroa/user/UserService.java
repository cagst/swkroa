...
public interface UserService extends UserDetailsService {
   ...
   * @param ipAddress The ipAddress of where the user signed in from.
   * @return A {@link User} that has been updated accordingly.
   * @throws IllegalArgumentException if the <code>user</code> is <code>null</code>.
   */
   ...
   *
   * @param username The username used trying to sign in.
   * @param message  A descriptive message of why the sign in failed.
   * @throws IllegalArgumentException if the <code>username</code> is <code>null</code> or empty.
   */
   ...
   *
   * @param user The {@link User} that has signed out of the system.
   */
   ...
   *
   * @param user The {@link User} that has timed out of the system.
   */
   ...
   * @param oldPassword     The old / current password (for re-authentication if required).
   * @param newPassword     The password to change to.
   * @param confirmPassword The re-entered password to change to.
   * @return A {@link User} that has been updated accordingly.
   * @throws BadCredentialsException if the oldPassword isn't valid, if the newPassword is the same as the new password,
