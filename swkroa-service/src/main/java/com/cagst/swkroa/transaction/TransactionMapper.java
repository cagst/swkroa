...
/* package */final class TransactionMapper implements RowMapper<Transaction> {
  ...
  public Transaction mapRow(final ResultSet rs, final int rowNum) throws SQLException {
    ...
    trans.setTransactionDate(DateTimeConverter.convert(rs.getTimestamp(TRANSACTION_DT)));
  ...
  private static void mapCommonProperties(final MapSqlParameterSource params,
    ...
    params.addValue(TRANSACTION_DT, DateTimeConverter.convert(transaction.getTransactionDate()));
