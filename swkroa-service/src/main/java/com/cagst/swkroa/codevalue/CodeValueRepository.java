...
public interface CodeValueRepository {
	...
	/**
	 * Retrieves a {@link Collection} of {@link CodeSet CodeSets} that are active within the system.
	 * 
	 * @return A {@link Collection} of {@link CodeSet CodeSets} that are active within the system.
	 */
	public List<CodeSet> getActiveCodeSets();

	/**
	 * Retrieves a {@link List} of {@link CodeValues} that are associated to the specified {@link CodeSet}.
	 * 
	 * @param codeSet
	 *          The {@link CodeSet} to retrieve CodeValues for.
	 * 
	 * @return A {@link List} of {@link CodeValues} that are associated to the specified {@link CodeSet}, an empty list if
	 *         no CodeValues are associated to the CodeSet.
	 */
	public List<CodeValue> getCodeValuesForCodeSet(final CodeSet codeSet);

	/**
	 * Retrieves a {@link List} of {@link CodeValues} that are associated to the {@link CodeSet} associated with the
	 * specified meaning.
	 * 
	 * @param codeSetMeaning
	 *          The meaning associated to the code set we want the code values for.
	 * 
	 * @return A {@link List} of {@link CodeValues} that are associated to the specified {@link CodeSet} meaning, an empty
