...
public class AuthenticationController {
	...
	public void changePassword(final @RequestParam String oldPassword, final @RequestParam String newPassword,
			final @RequestParam String confirmPassword, final HttpServletRequest request, final HttpServletResponse response)
			throws IOException {
