...
var BFHCountriesList = {
    ...
    BFHFontsList = {
        ...
        b.prototype = {
            ...
            addBootstrapCountries: function () {
                ...
                b.data("option", d), d && (this.options.flags === !0 ? b.html('<i class="glyphicon bfh-flag-' + d + '"></i>' + f[d]) : b.html(f[d])), a.val(d)
            },
    ...
    var d = "[data-toggle=bfh-datepicker]",
        e = function (b, c) {
    ...
    e.prototype = {
        ...
        parse: function (a, b) {
            ...
            for (c = this.options.format, d = c.indexOf("m"), e = c.indexOf("y"), f = c.indexOf("d"), g = [{
                ...
                return a.pos - b.pos
            }), h = b.match(/(\d+)/g), i = 0; i < g.length; i += 1)
                if (g[i].type === a) return Number(h[i]).toString()
        },
        ...
        updateCalendar: function () {
            ...
            for (c = a.find("table > tbody"), c.html(""), o = this.daysInMonth(e, f), p = this.daysInMonth(e + 1, f), q = this.dayOfWeek(e, f, 1), r = this.dayOfWeek(e, f, p), s = "", v = 0;
                (q - BFHDayOfWeekStart + 7) % 7 > v; v += 1) 0 === v && (s += "<tr>"), t = o - (q - BFHDayOfWeekStart + 7) % 7 + v + 1, s += '<td class="off">' + t + "</td>";
            ...
            for (v = 0, w = 1;
                (7 - (r + 1 - BFHDayOfWeekStart + 7) % 7) % 7 > v; v += 1, w += 1) s += '<td class="off">' + w + "</td>", v === (7 - (r + 1 - BFHDayOfWeekStart + 7) % 7) % 7 - 1 && (s += "</tr>", c.append(s))
        },
    ...
    var b = function (b, c) {
        ...
        if (this.options = a.extend({}, a.fn.bfhgooglefonts.defaults, c), this.$element = a(b), this.familyList = {}, this.options.subsets) {
            ...
            for (d in BFHGoogleFontsList.items)
                if (BFHGoogleFontsList.items.hasOwnProperty(d))
                    for (f = BFHGoogleFontsList.items[d], e = 0, g = !0; e <= this.options.subsets.length; e += 1) - 1 === a.inArray(this.options.subsets[e], f.subsets) && (g = !1), e === this.options.subsets.length - 1 && g === !0 && (this.familyList[f.family] = {
            ...
            for (d in BFHGoogleFontsList.items) BFHGoogleFontsList.items.hasOwnProperty(d) && (f = BFHGoogleFontsList.items[d], this.familyList[f.family] = {
                font: BFHGoogleFontsList.items[d],
                i: parseInt(d, 10)
            });
    ...
    b.prototype = {
        ...
        addLanguages: function () {
            var a, b, c, d, e, f;
            if (a = this.options.language, b = this.options.available, this.$element.html(""), this.options.allowBlank === !0 && this.$element.append('<option value=""></option>'), b.length > 0)
                for (c = b.split(","), f = 0; f < c.length; f += 1) d = c[f], -1 !== d.indexOf("_") ? (e = d.split("_"), this.$element.append('<option value="' + d + '">' + BFHLanguagesList[e[0]].toProperCase() + " (" + BFHCountriesList[e[1]] + ")</option>")) : this.$element.append('<option value="' + d + '">' + BFHLanguagesList[d].toProperCase() + "</option>");
            else
                for (d in BFHLanguagesList) BFHLanguagesList.hasOwnProperty(d) && this.$element.append('<option value="' + d + '">' + BFHLanguagesList[d].toProperCase() + "</option>");
            this.$element.val(a)
        },
        addBootstrapLanguages: function () {
            var a, b, c, d, e, f, g, h, i;
            if (d = this.options.language, e = this.options.available, a = this.$element.find('input[type="hidden"]'), b = this.$element.find(".bfh-selectbox-option"), c = this.$element.find("[role=option]"), c.html(""), this.options.allowBlank === !0 && c.append('<li><a tabindex="-1" href="#" data-option=""></a></li>'), e.length > 0)
                for (f = e.split(","), i = 0; i < f.length; i += 1) g = f[i], -1 !== g.indexOf("_") ? (h = g.split("_"), this.options.flags === !0 ? c.append('<li><a tabindex="-1" href="#" data-option="' + g + '"><i class="glyphicon bfh-flag-' + h[1] + '"></i>' + BFHLanguagesList[h[0]].toProperCase() + "</a></li>") : c.append('<li><a tabindex="-1" href="#" data-option="' + g + '">' + BFHLanguagesList[h[0]].toProperCase() + " (" + BFHCountriesList[h[1]] + ")</a></li>")) : this.$element.append('<option value="' + g + '">' + BFHLanguagesList[g].toProperCase() + "</option>");
            else
                for (g in BFHLanguagesList) BFHLanguagesList.hasOwnProperty(g) && c.append('<li><a tabindex="-1" href="#" data-option="' + g + '">' + BFHLanguagesList[g].toProperCase() + "</a></li>");
    ...
    function b() {
        var b;
        a(d).remove(), a(e).each(function (d) {
    ...
    var d = ".bfh-selectbox-backdrop",
        e = "[data-toggle=bfh-selectbox]",
        f = function (b) {
            a(b).on("click.bfhselectbox", this.toggle)
        };
    f.prototype = {
        constructor: f,
        toggle: function (d) {
            var e, f, g;
            if (e = a(this), e.is(".disabled") || void 0 !== e.attr("disabled")) return !0;
            if (f = c(e), g = f.hasClass("open"), b(), !g) {
                if ("ontouchstart" in document.documentElement && !f.closest(".navbar-nav").length && a('<div class="bfh-selectbox-backdrop"/>').insertAfter(a(this)).on("click", b), f.trigger(d = a.Event("show.bfhselectbox")), d.isDefaultPrevented()) return !0;
                f.toggleClass("open").trigger("shown.bfhselectbox").find('[role=option] > li > [data-option="' + e.find(".bfh-selectbox-option").data("option") + '"]').focus()
            }
            return !1
        },
        filter: function () {
        ...
        keydown: function (b) {
            var d, g, h, i, j;
            return /(38|40|27)/.test(b.keyCode) ? (d = a(this), b.preventDefault(), b.stopPropagation(), d.is(".disabled") || void 0 !== d.attr("disabled") ? !0 : (h = c(d), i = h.hasClass("open"), !i || i && 27 === b.keyCode ? (27 === b.which && h.find(e).focus(), d.click()) : (g = a("[role=option] li:not(.divider) a:visible", h), g.length ? (a("body").off("mouseenter.bfh-selectbox.data-api", "[role=option] > li > a", f.prototype.mouseenter), j = g.index(g.filter(":focus")), 38 === b.keyCode && j > 0 && (j -= 1), 40 === b.keyCode && j < g.length - 1 && (j += 1), j || (j = 0), g.eq(j).focus(), a("body").on("mouseenter.bfh-selectbox.data-api", "[role=option] > li > a", f.prototype.mouseenter), void 0) : !0))) : !0
        },
        mouseenter: function () {
            var b;
            return b = a(this), b.is(".disabled") || void 0 !== b.attr("disabled") ? !0 : (b.focus(), void 0)
        },
        select: function (d) {
            var e, f, g, h;
            return e = a(this), d.preventDefault(), d.stopPropagation(), e.is(".disabled") || void 0 !== e.attr("disabled") ? !0 : (f = c(e), g = f.find(".bfh-selectbox-option"), h = f.find('input[type="hidden"]'), g.data("option", e.data("option")), g.html(e.html()), h.removeData(), h.val(e.data("option")), a.each(e.data(), function (a, b) {
                h.data(a, b)
            }), h.trigger("change.bfhselectbox"), b(), void 0)
        }
    };
    var g = a.fn.bfhselectbox;
    a.fn.bfhselectbox = function (b) {
        return this.each(function () {
            var c, d;
            c = a(this), d = c.data("bfhselectbox"), this.type = "bfhselectbox", d || c.data("bfhselectbox", d = new f(this)), "string" == typeof b && d[b].call(c)
        })
    }, a.fn.bfhselectbox.Constructor = f, a.fn.bfhselectbox.noConflict = function () {
        return a.fn.bfhselectbox = g, this
    };
    var h;
    a.valHooks.div && (h = a.valHooks.div), a.valHooks.div = {
        get: function (b) {
            return a(b).hasClass("bfh-selectbox") ? a(b).find('input[type="hidden"]').val() : h ? h.get(b) : void 0
        },
        set: function (b, c) {
    ...
    }, a(document).on("click.bfhselectbox.data-api", b).on("click.bfhselectbox.data-api focus.bfhselectbox.data-api touchstart.bfhselectbox.data-api", e, f.prototype.toggle).on("keydown.bfhselectbox.data-api", e + ", [role=option]", f.prototype.keydown).on("mouseenter.bfhselectbox.data-api", "[role=option] > li > a", f.prototype.mouseenter).on("click.bfhselectbox.data-api", "[role=option] > li > a", f.prototype.select).on("click.bfhselectbox.data-api", ".bfh-selectbox-filter", function () {
        return !1
    }).on("propertychange.bfhselectbox.data-api change.bfhselectbox.data-api input.bfhselectbox.data-api paste.bfhselectbox.data-api", ".bfh-selectbox-filter", f.prototype.filter)
}(window.jQuery), + function (a) {
    "use strict";
    var b = function (b, c) {
    ...
    b.prototype = {
        ...
        loadBootstrapStates: function (a) {
            ...
            c.data("option", e), "" !== f ? c.html(f) : c.html(""), b.val(e)
        },
    ...
    var d = "[data-toggle=bfh-timepicker]",
        e = function (b, c) {
    ...
    }, a.fn.bfhtimepicker.Constructor = e, a.fn.bfhtimepicker.defaults = {
        time: ""
    }, a(window).on("load", function () {
    ...
    b.prototype = {
        ...
        addTimezones: function () {
            var a, b, c;
            a = this.options.country, "" !== a && (b = this.$element.closest("form"), c = b.find("#" + a), 0 !== c.length && (a = c.val(), c.on("change.bfhcountries.data-api", {
                timezoneObject: this
        ...
        addBootstrapTimezones: function () {
            var a, b, c;
            a = this.options.country, "" !== a && (b = this.$element.closest("form"), c = b.find("#" + a), 0 !== c.length && (a = c.find('input[type="hidden"]').val(), c.find('input[type="hidden"]').on("change.bfhcountries.data-api", {
                timezoneObject: this
