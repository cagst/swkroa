...
public final class TransactionEntry implements Serializable {
  ...
  private Transaction related_transaction;
	...
	private String transaction_entry_desc;
  ...
  public void setRelatedTransaction(final Transaction trans) {
	...
	public String getTransactionEntryDescription() {
		return transaction_entry_desc;
	}

	public void setTransactionEntryDescription(final String desc) {
		this.transaction_entry_desc = desc;
	}
	...
	public String toString() {
		...
		builder.append("transaction_entry_desc", transaction_entry_desc);
	...
	public int hashCode() {
		...
		builder.append(transaction_entry_desc);
	...
	public boolean equals(final Object obj) {
		...
		builder.append(transaction_entry_desc, rhs.getTransactionEntryDescription());
